...
export default function SeatChoice({
  ...
  return (
    <Container>
      ...
      {infoMovie ? (
        <MovieFooter
          poster={infoMovie.movie.posterURL}
          movie={infoMovie.movie.title}
          session={infoMovie.name}
          day={infoMovie.day.weekday}
        />
      ) : (
        "Carregando..."
      )}
